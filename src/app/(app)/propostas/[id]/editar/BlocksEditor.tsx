...
const KIND_LABEL: Record<BlocoKind, string> = {
  text: "Texto livre",
  image: "Imagem",
  flight: "Voo",
  hotel: "Hotel",
...
type ContentField = { key: string; label: string; type?: "text" | "date"; placeholder?: string };

const CONTENT_FIELDS: Partial<Record<BlocoKind, ContentField[]>> = {
  flight: [
