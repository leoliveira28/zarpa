/**
 * Schema v1 do Zarpa — 19 tabelas (17 do S1 + `import_batches` no S3 + `library_items`
 * no S5/S6).
 *
 ...
 * na migration que cria a tabela (`0000_fundacao.sql`, `0001_pessoas_e_importacao.sql` ou
 * `0003_construtor_de_proposta.sql`, dependendo da tabela — nunca numa migration depois).
